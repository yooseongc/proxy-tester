...
$scenario = @{
    version = 2; id = [guid]::NewGuid().ToString(); name = 'tcp-capture-replay'
    topology = 'transparent_proxy'; protocol = 'tcp'
...
$scenario.topology = 'transparent_proxy'; $scenario.proxy_addr = $null
